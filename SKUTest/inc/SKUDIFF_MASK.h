...
#define SDF_SERVICESFORNFS  (SKUS_ENTERPRISE | SKUS_ULTIMATE)
...
//
//Windows Features (aka Optional Components)
//
//FREECELL HEARTS MINESWEEPER PURBLEPLACE SOLITAIRE SPIDER
#define SDF_WFA_GAMES	(SKUS_ALL)

//CHESS INKBALL MAHJONG
#define SDF_WFA_PREMIUM_GAMES	(SKUS_ALL & ~(SKU_STARTER | SKUS_HOME_BASIC))

#define SDF_WFA_FAXSCAN (SKUS_PRO)

#define SDF_WFA_ACTIVEX	(SKUS_PRO)

#define SDF_WFA_MEETINGSPACE (SKUS_ALL & ~(SKU_STARTER))

#define SDF_WFA_EXTRAS (SKU_ULTIMATE)

#define SDF_WFA_TABLET (SDF_TABLETPC)

#define SDF_WFA_UNIX (SDF_SERVICESFORUNIX)

#define SDF_WFA_NFS (SDF_SERVICESFORNFS)



/*
#define SDF_WFD_ACTIVEX	& ~(SKU_ULTIMATE
#define SDF_WFD_GAMES	(SKUS_ALL & ~(SKUS_BUSINESS | SKUS_ENTERPRISE))

#define SDF_WFD_PREMIUM_GAMES	(SKUS_ALL & ~(SKU_STARTER | SKUS_HOME_BASIC | SKUS_BUSINESS | SKUS_ENTERPRISE))
#define SDF_WFD_FAXSCAN (SKU_ULTIMATE | SKU_BUSINESS)

#define SDF_WFD_MEETINGSPACE (SKUS_ALL & ~(SKU_STARTER))
#define SDF_WFD_EXTRAS (SKU_ULTIMATE)
#define SDF_WFD_TABLET (SDF_TABLETPC)
#define SDF_WFD_UNIX (SDF_SERVICESFORUNIX)
#define SDF_WFD_NFS (SDF_SERVICESFORNFS)
INDEXING (SKU_ULTIMATE
INDEXING & ~(SKU_ULTIMATE
IIS (SKU_ULTIMATE
IIS & ~(SKU_ULTIMATE
DOTNET (SKU_ULTIMATE
...
SNMP (SKU_ULTIMATE
SNMP & ~(SKU_ULTIMATE
TELNETCLIENT (SKU_ULTIMATE
TELNETCLIENT & ~(SKU_ULTIMATE
TELNETSERVER (SKU_ULTIMATE
TELNETSERVER & ~(SKU_ULTIMATE
TFTP (SKU_ULTIMATE
TFTP & ~(SKU_ULTIMATE
DFS (SKU_ULTIMATE
...
int GetCurrentSKUMask()
{
	...
	if (GetProductInfo(WINDOWS_VISTA_VERSION, 0, 0, 0, &dwProductInfoType))
	{
		...
		case PRODUCT_HOME_BASIC:
			return SKU_HOME_BASIC;
		case PRODUCT_HOME_PREMIUM:
			return SKU_HOME_PREMIUM;
		...
		case PRODUCT_HOME_BASIC_N:
			return SKU_HOME_BASIC_N;
		case PRODUCT_HOME_PREMIUM_N:
			return SKU_HOME_PREMIUM_N;
		case PRODUCT_BUSINESS_N:
			return SKU_BUSINESS_N;
		case PRODUCT_ENTERPRISE_N:
			return SKU_ENTERPRISE_N;
		case PRODUCT_ULTIMATE_N:
			return SKU_ULTIMATE_N;
		default:
			return 0;			
		}
	}
